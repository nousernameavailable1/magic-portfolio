...
summary: "Create, edit and delete projects in the projects section of your Magic Portfolio."
...
You can create, edit and delete projects by adding, modifying or removing `*.mdx` files in the `src/app/projects/projects` directory.
...
---`,
        language: "tsx",
        label: "src/app/projects/projects/project-1.mdx"
      }
    ]}
/>
