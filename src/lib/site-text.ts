...
export const siteTextDefinitions = [
  ...
  {
    key: "access.headline",
    label: "Access headline",
    description: "The large heading on the left side of the Access page.",
    defaultValue: "This page is for invited eyes only.",
    maxLength: 120,
    lines: 2,
  },
  {
    ...
    description: "The sentence beneath the main Access page heading.",
    defaultValue: "Don't have access? Womp womp.",
    maxLength: 300,
    lines: 3,
  },
  {
    key: "access.formHeading",
    label: "Access form heading",
    description: "The heading above the password field on the Access page.",
    defaultValue: "This page is intentionally restricted",
    maxLength: 120,
    lines: 2,
  },
  {
